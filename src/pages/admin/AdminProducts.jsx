          ...
          {deleteTarget && (
            ...
            >
              <p className="text-red-300 text-sm">
                حذف منتج <strong>{deleteTarget.name}</strong>؟ لا يمكن التراجع
                عن هذا الإجراء.
              </p>
            ...
            return (
              ...
              >
                <div className="relative h-44 overflow-hidden bg-zinc-800">
                  ...
                  {p.badge && (
                    <span
                      className={`absolute top-2 right-2 px-2 py-0.5 rounded-full text-xs font-bold ${p.badgeColor === "gold" ? "bg-gold-500 text-black" : "bg-red-500 text-white"}`}
                    >
                      {p.badge}
                    </span>
                  )}
                ...
                <div className="p-4">
                  <div className="flex items-start justify-between gap-2 mb-1">
                    ...
                    <div className="flex items-center gap-1 flex-shrink-0">
                      ...
                      <span className="text-xs text-gold-400">{p.rating}</span>
                    </div>
                  </div>
                  <div className="flex items-center justify-between mt-2">
                    ...
                    <div className="flex items-center gap-2">
                      <span
                        className={`text-xs px-2 py-0.5 rounded-lg font-medium ${stCfg.color} ${stCfg.bg}`}
                      >
                        {stCfg.label}
                      </span>
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-4">
                        ...
                        >
                          {uploading ? (
                            <>
                              ...
                              <span className="text-xs">{uploadPct}%</span>
                            </>
                          ) : (
                            <>
                              <MdCloudUpload className="text-3xl" />
                              <span className="text-xs">
                                ارفع صورة أو ألصق رابط
                              </span>
                            </>
                          )}
                        </button>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      rows={2}
                      className="w-full px-4 py-2.5 rounded-xl bg-zinc-800 border border-zinc-700 text-white placeholder-zinc-500 outline-none focus:border-gold-500 text-sm resize-none"
                    />
                  </div>
                  ...
                  <div className="flex gap-3 pt-2">
                    <button
                      type="button"
                      onClick={() => setShowModal(false)}
                      className="flex-1 py-3 rounded-xl border border-zinc-700 text-zinc-400 hover:bg-zinc-800 transition-all text-sm"
                    >
                      إلغاء
                    </button>
                    <button
                      type="submit"
                      className="flex-1 py-3 rounded-xl bg-gold-500 hover:bg-gold-600 text-black font-bold transition-all text-sm"
                    >
