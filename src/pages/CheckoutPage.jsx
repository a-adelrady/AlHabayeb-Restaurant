    ...
    return (
      <div className="min-h-screen dark:bg-zinc-950 bg-gray-50 pt-20 flex items-center justify-center px-4">
        <div className="text-center">
          ...
          <Link
            to="/menu"
            className="bg-gold-500 text-black font-bold px-6 py-3 rounded-xl inline-block"
          >
            تصفح المنيو
          </Link>
        </div>
          ...
          <form onSubmit={handleSubmit} noValidate>
            <div className="grid lg:grid-cols-3 gap-6">
              ...
              <div className="lg:col-span-2 space-y-5">
                ...
                <div className="dark:bg-zinc-900 bg-white rounded-2xl p-6 border dark:border-zinc-800 border-gray-100">
                  <h2 className="font-bold text-lg dark:text-white text-gray-900 mb-5 flex items-center gap-2">
                    <MdPerson className="text-gold-500 text-xl" /> بيانات
                    التوصيل
                  </h2>
                  <div className="space-y-4">
                    ...
                    <Field
                      label="رقم الموبايل *"
                      error={errors.phone}
                      hint="أرقام مصرية فقط: 010 / 011 / 012 / 015"
                    >
                ...
                <div className="dark:bg-zinc-900 bg-white rounded-2xl p-6 border dark:border-zinc-800 border-gray-100">
                  <h2 className="font-bold text-lg dark:text-white text-gray-900 mb-4 flex items-center gap-2">
                    <MdDeliveryDining className="text-gold-500 text-xl" /> منطقة
                    التوصيل
                  </h2>
                  {errors.zone && (
                ...
                {/* Payment */}
                <div className="dark:bg-zinc-900 bg-white rounded-2xl p-6 border dark:border-zinc-800 border-gray-100">
                  <h2 className="font-bold text-lg dark:text-white text-gray-900 mb-4">
                    طريقة الدفع
                  </h2>
                  <div className="flex items-center gap-3 p-4 rounded-xl border-2 border-gold-500 bg-gold-500/10">
                    <div
                      className="w-4 h-4 rounded-full border-2 border-gold-500 flex items-center justify-center"
                      aria-hidden="true"
                    >
                      <div className="w-2 h-2 rounded-full bg-gold-500" />
                    </div>
                    <div>
                      ...
                      <p className="text-xs dark:text-zinc-400 text-gray-500">
                        ادفع كاش عند استلام طلبك
                      </p>
                    </div>
                    <span className="mr-auto text-2xl" aria-hidden="true">
                      💵
                    </span>
                  </div>
                </div>
              ...
              <div className="lg:col-span-1">
                <div className="dark:bg-zinc-900 bg-white rounded-2xl p-4 md:p-6 border dark:border-zinc-800 border-gray-100 lg:sticky lg:top-24">
                  <h2 className="font-bold text-lg dark:text-white text-gray-900 mb-4 flex items-center gap-2">
                  ...
                  <div className="space-y-2 mb-4 max-h-48 overflow-y-auto">
                    {cartItems.map((item) => (
                      ...
                      >
                        ...
                        <span className="dark:text-white text-gray-900 font-medium mr-2 flex-shrink-0">
                  ...
                  >
                    {loading ? (
                      ...
                      <>
                        <MdWhatsapp className="text-2xl" /> تأكيد الطلب عبر
                        واتساب
                      </>
                    )}
                  </motion.button>
...
function Field({ label, error, hint, children }) {
  return (
    <div>
      <label className="block text-sm font-medium dark:text-zinc-300 text-gray-700 mb-2">
        {label}
      </label>
